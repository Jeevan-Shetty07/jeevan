...
export default function Projects() {
  ...
  return (
    ...
    >
      {/* Heading */}
      <h2
        className="text-4xl md:text-5xl font-extrabold mb-14 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600"
        data-aos="fade-down"
      >
        🚀 Projects
      </h2>
      ...
      <div className="grid md:grid-cols-3 gap-10 max-w-7xl w-full">
        {projects.map((proj, index) => (
          <div
            key={index}
            className="relative p-6 rounded-2xl shadow-lg bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-md border border-gray-700 hover:scale-105 transition-transform duration-300"
            data-aos="zoom-in-up"
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium rounded-lg shadow-md hover:shadow-blue-500/50 hover:scale-110 transition"
            >
