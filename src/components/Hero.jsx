...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex flex-col lg:flex-row items-center justify-center gap-y-8 lg:gap-x-16 px-6 sm:px-8 md:px-12 lg:px-20 bg-black text-white"
    >
     
      <div className="absolute -top-20 -left-28 w-56 sm:w-72 md:w-80 lg:w-96 h-56 sm:h-72 md:h-80 lg:h-96 bg-purple-700 opacity-30 rounded-full blur-3xl"></div>
      <div className="absolute -bottom-28 -right-28 w-56 sm:w-72 md:w-80 lg:w-96 h-56 sm:h-72 md:h-80 lg:h-96 bg-blue-700 opacity-30 rounded-full blur-3xl"></div>

    
      <div className="z-10 flex-1 max-w-2xl text-center lg:text-left px-2 sm:px-0">
        <motion.h1
        ...
        >
          <a
            ...
            className="px-5 sm:px-6 py-3 bg-blue-600 text-white rounded-xl shadow-lg hover:bg-blue-700 hover:scale-105 transition text-sm sm:text-base"
          >
            📄 Download Resume
          </a>
          <a
            href="#projects"
            className="px-5 sm:px-6 py-3 bg-gray-800 text-white rounded-xl shadow-lg hover:bg-gray-900 hover:scale-105 transition text-sm sm:text-base"
          >
            🔗 View Projects
          </a>
        </motion.div>
